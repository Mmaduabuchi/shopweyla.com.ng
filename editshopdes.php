    ...
    if (empty($shopdes)) {
      ...
      if (!$checkdb) {
        ...
        if (mysqli_num_rows($checkdb) < 1) {
          ...
          $update = "UPDATE shop SET shopdetails='$shopdes' WHERE userkey='$userkey'";
          if (!mysqli_query($connection, $update)) {
            $errorMsg = "Can not change shop description try again later.";
          }else {
            $successmsg = "Shop description changed.";
          }
        }
      }
    }
    ...
    <div class="row bg-light mt-5">
      ...
      <div class="col mb-5">        
        <form action="<?php  echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="pt-4">
            <label for="">Change Shop Description</label>
            <textarea name="shopdes" class="form-control" placeholder="Add new contents here...." cols="30" rows="10"></textarea>
