<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $body = $_POST["userMessage"];
    $headers = $_POST["userName"];
    //validate user email
    if (!filter_var($to_email, FILTER_VALIDATE_EMAIL)) {
      $message = "invaild Email";
    }else {
      //send mail to users email adderss entered
      if(mail($to_email,$subject,$body,$headers)){
        $message = "Email sent to this email successfully.";
      }else {
        $message = "Email was not send try again";
      }
    }    
  }
...
<head>
  ...
  <title>Contact - shopweyla.com.ng</title>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>picank.tech.hub@gmail.com<br>emmanuelukwe1@gmail.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p>+234 813 282 4987<br>+234 813 375 7923</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" role="form" class="php-email-form">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="userSubject" id="subject" placeholder="Subject" required>
              </div>
              <div class="form-group mt-3">
                <textarea class="form-control" name="userMessage" rows="5" placeholder="Message" required></textarea>
              </div>
              <div class="my-3">
